...
void Lab8::Init()
{
    ...
    // Light & material properties
    {
        ...
        lightPosition2 = glm::vec3(2, 1, 0);
        lightDirection2 = glm::vec3(0, 1, 0);
        materialShininess2 = 30;
        materialKd2 = 0.5f;
        materialKs2 = 0.5f;
        typeOfLight2 = 0; // Poate fi 0 pentru lumină punctiformă sau 1 pentru spot
        cutoffAngle2 = 30.f;
...
void Lab8::Update(float deltaTimeSeconds)
{
...

    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.0f, 1.0f, 0.0f));
    ...
    // Renderizarea noii surse de lumină în scenă
    {
        glm::mat4 modelMatrix = glm::mat4(1);
...
void Lab8::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    glUniform3f(glGetUniformLocation(shader->program, "light_position2"), lightPosition2.x, lightPosition2.y, lightPosition2.z);
    glUniform3f(glGetUniformLocation(shader->program, "light_direction2"), lightDirection2.x, lightDirection2.y, lightDirection2.z);
    glUniform1i(glGetUniformLocation(shader->program, "type_of_light2"), typeOfLight2);
    glUniform1f(glGetUniformLocation(shader->program, "cut_off_angle2"), cutoffAngle2);
    // Draw the object
...
void Lab8::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        // Controlul noii surse de lumină
