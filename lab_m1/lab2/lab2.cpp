...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0.43, 0.8, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.9, 0.1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0.75, 0.4, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0.3, 0.5, 0.5), glm::vec3(0.2, 0.8, 0.6)),
        ...
        vector<VertexFormat> vertices2
        {
            ...
            VertexFormat(glm::vec3(2, 0,  2), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(3, 0,  1), glm::vec3(0.43, 0.8, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1.5, 3,  0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
        ...
        vector<VertexFormat> square_vertices
        {
            ...
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0.43, 0.8, 0), glm::vec3(0.2, 0.8, 0.6)),
        ...
        meshes["tetrahedron"]->InitFromData(vertices2, indices1);

        meshes["square"] = new Mesh("generated square");
        meshes["square"]->InitFromData(square_vertices, indicesSquare);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-1, 0.5f, 2), glm::vec3(0.25f));



    // TODO(student): Draw the mesh that was created with CreateMesh()
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-1.8, 0.5f, 2), glm::vec3(0.25f));


    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 0.5f, 2.4), glm::vec3(0.25f));
