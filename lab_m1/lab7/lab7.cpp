...
{
	// Obiect 1: Sferă albastră deschisă
	{
		glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(0, 1, 0));
		RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.3f, 0.7f, 1.0f)); // Nuanță mai deschisă
	}

	

	// Render ground (plan roz)
	{
		glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(0, 0.01f, 0));
		modelMatrix = glm::scale(modelMatrix, glm::vec3(0.25f));
		RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(1.0f, 0.4f, 0.7f)); // Roz
	}
